...
int main() {
	...
	Shader* shader = load_shader("D://Игры/voxel_engine/res/vertex.txt", "D://Игры/voxel_engine/res/fragment.glslf.txt");
	if (shader == nullptr) 
	{
	...
	Texture* texture = load_texture("D://Игры/Voxel_engine/res/testimg~.png");
	if (texture == nullptr) 
	{
